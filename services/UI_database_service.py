# Modify the code below to create a nice and good looking dark mode, that is light on the eyes and looks great, use these colors: Black #24262C, Pink #C9ADA7, Rose quartz #9A8C98
...
class CredentialsViewer:
    def __init__(self, master):
        ...
        self.cm = CredentialsManager()  # Replace with your actual CredentialsManager
        ...
        if credentials_list:
            ...
            for credentials in credentials_list:
                ...
                self.credentials_tree.insert(
                    "",
                    "end",
                    values=(email, email_password, account_id, account_password,mega_links),
                )
